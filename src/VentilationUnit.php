...
class VentilationUnit
{
    ...
    public function __construct($ipAddress, $lang)
    {
        ...
        // generate register
        $this->register['CurrentDateTime'] = new DateTime(
            $modbus,
            40109,
            'prmDateTime',
            'Current date/time',
        ...
        $this->register['StartExploitationDate'] = new DateTime(
            $modbus,
            40669,
            'prmStartExploitationDateStamp',
            'date/time of the system start',
            'date-time-format'
        );
        $this->register['WorkTime'] = new Numeric(
            $modbus,
            40625,
            'prmWorkTime',
            'Work time of system, in hours',
            '%s hours'
        );
        $this->register['OutdoorTemperature'] = new Floating(
            $modbus,
            40133,
            'prmRamIdxT1',
        ...
        $this->register['SupplyTemperature'] = new Floating(
            $modbus,
            40135,
            'prmRamIdxT2',
        ...
        $this->register['ExtractTemperature'] = new Floating(
            $modbus,
            40137,
            'prmRamIdxT3',
        ...
        $this->register['ExhaustTemperature'] = new Floating(
            $modbus,
            40139,
            'prmRamIdxT4',
        ...
        $this->register['FanSpeedLevel'] = new FanSpeedLevel(
            $modbus,
            40325,
            'prmRomIdxSpeedLevel',
            'Speed level of Fans',
        ...
        $this->register['FanSpeed1'] = new Floating(
            $modbus,
            40101,
            'prmHALTaho1',
            'Fan1 rpm',
        ...
        $this->register['FanSpeed2'] = new Floating(
            $modbus,
            40103,
            'prmHALTaho2',
            'Fan2 rpm',
        ...
        $this->register['FilterDefaultTime'] = new FilterDefaultTime(
            $modbus,
            40555,
            'prmFilterDefaultTime',
            'Filter Lifetime (Days)',
            '%s days'
        );
        $this->register['FilterRemainingTime'] = new Numeric(
            $modbus,
            40555,
        ...
        $this->register['BypassTemperatureMin'] = new Floating(
            $modbus,
            40445,
            'prmBypassTmin',
            'Min temperature for outdoor air',
            '%s °C'
        );
        $this->register['BypassTemperatureMax'] = new Floating(
            $modbus,
            40447,
            'prmBypassTmax',
            'Max temperature for extract air',
            '%s °C'
        );
        $this->register['BypassManualTimeout'] = new Numeric(
            $modbus,
            40265,
        ...
        $this->register['BypassState'] = new BypassState(
            $modbus,
            40199,
            'prmRamIdxBypassActualState',
            'Bypass state'
        );
        $this->register['PreheaterDutyCycle'] = new Numeric(
            $modbus,
            40161,
            'prmPreheaterDutyCycle',
            'Power of Preheater in %',
            '%s %%'
        );
        $this->register['CurrentBLState'] = new CurrentBLState(
            $modbus,
            40473,
            'prmCurrentBLState',
            'Current unit mode'
        );
        $this->register['UnitMode'] = new UnitMode(
            $modbus,
            40169,
            'prmRamIdxUnitMode',
            'Active Unit mode'
        );
        $this->register['WeekProgram'] = new WeekProgram(
            $modbus,
            40467,
            'prmNumOfWeekProgram',
            'Number of the Active Week Program (for Week Program mode)'
        );
        $this->register['Alarm'] = new Alarm(
            $modbus,
            40517,
            'prmLastActiveAlarm',
